        ...
        if ($translate->isAllowed()) {
            ...
            $languageRoutes = array(
                array(
                    ...
                    'store_id' => $storeId,
                    'is_active' => 1,
                    'value' => $this->getRequest()->getParam('route_untranslated', false),
                ...
                array(
                    ...
                    'store_id' => $storeId,
                    'is_active' => 1,
                    'value' => $this->getRequest()->getParam('controller_untranslated', false),
                ...
                array(
                    ...
                    'store_id' => $storeId,
                    'is_active' => 1,
                    'value' => $this->getRequest()->getParam('action_untranslated', false),
            ...
            if ($returlUrl) {
                $this->_redirect(sprintf('%s/%s/%s', $newRoute, $newController, $newAction));
            }
            else {
